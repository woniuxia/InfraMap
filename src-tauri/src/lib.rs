...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::systems::list_services_by_system,
            ...
            commands::topology::get_topology_drilldown_v3,
            ...
            commands::system_jobs::list_system_jobs,
            commands::system_jobs::get_system_job_detail,
            commands::system_jobs::retry_system_job,
            commands::system_jobs::cancel_system_job,
            commands::integrity::get_integrity_report,
            commands::integrity::scan_integrity,
            commands::integrity::repair_integrity_findings,
            ...
            commands::snapshot::preview_snapshot_v2,
            commands::snapshot::export_snapshot_v2,
            commands::snapshot::import_snapshot_v2,
